...
def oi_grid(glon, glat, gtime):
    ...
    vtime = (gtime - gtime[0]) / numpy.timedelta64(1, 'D')
...
def oi_core(it, ds_oi_grid, ds_oi_param, ds_obs):
    ...
    obs_lon = ds_obs.longitude.values[ind1]
    obs_lat = ds_obs.latitude.values[ind1]
    ...
    sol = numpy.dot(numpy.dot(BHt, Mi), ds_obs.sla_unfiltered.values[ind1])
