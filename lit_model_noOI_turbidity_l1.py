...
class LitModelOI(LitModelAugstate):
    ...
    def sla_loss(self, gt, out):
        ...
        loss = NN_4DVar.compute_spatio_temp_l1_weighted_loss((out - gt), self.patch_weight)
        loss_grad = (
                NN_4DVar.compute_spatio_temp_l1_weighted_loss(g_outputs_x - g_gt_x, self.grad_crop(self.patch_weight))
            +    NN_4DVar.compute_spatio_temp_l1_weighted_loss(g_outputs_y - g_gt_y, self.grad_crop(self.patch_weight))
        )
