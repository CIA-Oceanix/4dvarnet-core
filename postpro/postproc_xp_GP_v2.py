...
for ipatch in range(19):   
    ...
    # No parameters
    im2 = plot(ax2,gt.lon,gt.lat,oi_analytical.values,'OI (analytical)',extent=extent,cmap=cmap,norm=norm,colorbar=False,fs=18)
    ax3.set_visible(False)
    ax4.set_visible(False)
    # MSE loss
    im5 = plot(ax5,gt.lon,gt.lat,unet_mse_loss.values,'UNet (MSE loss)',extent=extent,cmap=cmap,norm=norm,colorbar=False,fs=18)
    im6 = plot(ax6,gt.lon,gt.lat,fourdvarnet_lstm_phi_cov_mse_loss.values,'4DVarNet-OI (Prior: Cov) (MSE loss)',extent=extent,cmap=cmap,norm=norm,colorbar=False,fs=18)
    im7 = plot(ax7,gt.lon,gt.lat,fourdvarnet_lstm_phi_unet_mse_loss.values,'4DVarNet-OI (Prior: UNet) (MSE loss)',extent=extent,cmap=cmap,norm=norm,colorbar=False,fs=18)
    # MSE OI loss
    im8 = plot(ax8,gt.lon,gt.lat,unet_mseoi_loss.values,'UNet (MSE OI loss)',extent=extent,cmap=cmap,norm=norm,colorbar=False,fs=18)
    im9 = plot(ax9,gt.lon,gt.lat,fourdvarnet_lstm_phi_cov_mseoi_loss.values,'4DVarNet-OI (Prior: Cov) (MSE OI loss)',extent=extent,cmap=cmap,norm=norm,colorbar=False,fs=18)
    im10 = plot(ax10,gt.lon,gt.lat,fourdvarnet_lstm_phi_unet_mseoi_loss.values,'4DVarNet-OI (Prior: UNet) (MSE OI loss)',extent=extent,cmap=cmap,norm=norm,colorbar=False,fs=18)
    # OI loss
    im11 = plot(ax11,gt.lon,gt.lat,unet_oi_loss.values,'UNet (OI loss)',extent=extent,cmap=cmap,norm=norm,colorbar=False,fs=18)
    im12 = plot(ax12,gt.lon,gt.lat,fourdvarnet_lstm_phi_cov_oi_loss.values,'4DVarNet-OI (Prior: Cov) (OI loss)',extent=extent,cmap=cmap,norm=norm,colorbar=False,fs=18)
    im13 = plot(ax13,gt.lon,gt.lat,fourdvarnet_lstm_phi_unet_oi_loss.values,'4DVarNet-OI (Prior: UNet) (OI loss)',extent=extent,cmap=cmap,norm=norm,colorbar=False,fs=18)
    ...
    p5 = plt.plot(unet_oi_loss_loss_oi, unet_oi_loss_loss_mse, '-^', c='slategray', alpha=0.5, label='UNet (MSE OI loss)')
    
    p6 = plt.plot(fourdvarnet_lstm_phi_unet_mse_loss_loss_oi, fourdvarnet_lstm_phi_unet_mse_loss_loss_mse, '-o', c='darkslateblue', alpha=0.5,label='4DVarNet-OI (Prior: UNet) (MSE loss)')
    p7 = plt.plot(fourdvarnet_lstm_phi_unet_oi_loss_loss_oi, fourdvarnet_lstm_phi_unet_oi_loss_loss_mse, 's--', c='darkslateblue', alpha=0.5,label='4DVarNet-OI (Prior: UNet) (OI loss)')
    p8 = plt.plot(fourdvarnet_lstm_phi_unet_mseoi_loss_loss_oi, fourdvarnet_lstm_phi_unet_mseoi_loss_loss_mse, '-^', c='darkslateblue', alpha=0.5,label='4DVarNet-OI (Prior: UNet) (MSE OI loss)')
    
    p9 = plt.plot(fourdvarnet_lstm_phi_cov_mse_loss_loss_oi, fourdvarnet_lstm_phi_cov_mse_loss_loss_mse, '-o', c='firebrick', alpha=0.5,label='4DVarNet-OI (Prior: Cov) (MSE loss)')
    p10 = plt.plot(fourdvarnet_lstm_phi_cov_oi_loss_loss_oi, fourdvarnet_lstm_phi_cov_oi_loss_loss_mse, 's--', c='firebrick', alpha=0.5,label='4DVarNet-OI (Prior: Cov) (OI loss)')
    p11 = plt.plot(fourdvarnet_lstm_phi_cov_mseoi_loss_loss_oi, fourdvarnet_lstm_phi_cov_mseoi_loss_loss_mse, '-^', c='firebrick', alpha=0.5,label='4DVarNet-OI (Prior: Cov) (MSE OI loss)')
    ...
    labels.insert(1,'')
    order = [11,2,5,8,0,3,6,9,1,4,7,10]
    ...
    p5 = plt.plot(np.arange(len(unet_mseoi_loss_loss_mse)), unet_mseoi_loss_loss_oi, '-^', c='slategray', alpha=0.5, label='UNet (MSE OI loss)')
    
    p6 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_unet_mse_loss_loss_oi)), fourdvarnet_lstm_phi_unet_mse_loss_loss_oi, '-o', c='darkslateblue', alpha=0.5,label='4DVarNet-OI (Prior: UNet) (MSE loss)')
    p7 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_unet_oi_loss_loss_oi)), fourdvarnet_lstm_phi_unet_oi_loss_loss_oi, 's--', c='darkslateblue', alpha=0.5,label='4DVarNet-OI (Prior: UNet) (OI loss)')
    p8 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_unet_mseoi_loss_loss_oi)), fourdvarnet_lstm_phi_unet_mseoi_loss_loss_oi, '-^', c='darkslateblue', alpha=0.5,label='4DVarNet-OI (Prior: UNet) (MSE OI loss)')
    
    p9 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_cov_mse_loss_loss_oi)), fourdvarnet_lstm_phi_cov_mse_loss_loss_oi, '-o', c='firebrick', alpha=0.5,label='4DVarNet-OI (Prior: Cov) (MSE loss)')
    p10 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_cov_oi_loss_loss_oi)), fourdvarnet_lstm_phi_cov_oi_loss_loss_oi, 's--', c='firebrick', alpha=0.5,label='4DVarNet-OI (Prior: Cov) (OI loss)')
    p11 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_cov_mseoi_loss_loss_oi)), fourdvarnet_lstm_phi_cov_mseoi_loss_loss_oi, '-^', c='firebrick', alpha=0.5,label='4DVarNet-OI (Prior: Cov) (MSE OI loss)') 
