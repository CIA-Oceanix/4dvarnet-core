...
for ipatch in range(19):   
    ...
    # REF
    oi_analytical = find_open_ncdf("oi_gp_4dvarnet_mse_loss_"+gp_dataset)['4DVarNet'].isel(time=ipatch)
    ...
    fourdvarnet_fp_phi_unet_mse_loss = find_open_ncdf("oi_gp_4dvarnet_fp_mseoi_loss_"+gp_dataset)['4DVarNet'].isel(time=ipatch)
    ...
    fourdvarnet_lstm_phi_cov_mseoi_loss = find_open_ncdf("oi_gp_spde_wolp_mse_loss_"+gp_dataset).pred.isel(time=ipatch,daw=2)
    ...
    fourdvarnet_lstm_phi_unet_mseoi_loss = find_open_ncdf("oi_gp_4dvarnet_mse_loss_"+gp_dataset)['4DVarNet'].isel(time=ipatch)
