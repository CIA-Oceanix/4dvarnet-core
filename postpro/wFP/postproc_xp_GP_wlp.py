...
for ipatch in range(19):   
    ...
    p5 = plt.plot(fourdvarnet_fp_phi_unet_mse_loss_loss_oi, fourdvarnet_fp_phi_unet_mse_loss_loss_mse, '-o', c='darkorange', alpha=0.5,label='Prior: UNet / Solver: FP10 (mse loss)')
    p6 = plt.plot(fourdvarnet_fp_phi_unet_oi_loss_loss_oi, fourdvarnet_fp_phi_unet_oi_loss_loss_mse, 's--', c='darkorange', alpha=0.5,label='Prior: UNet / Solver: FP10 (oi loss)')

    p7 = plt.plot(fourdvarnet_lstm_phi_unet_mse_loss_loss_oi, fourdvarnet_lstm_phi_unet_mse_loss_loss_mse, '-o', c='darkslateblue', alpha=0.5,label='Prior: UNet / Solver: LSTM (20 updates) (mse loss)')
    p8 = plt.plot(fourdvarnet_lstm_phi_unet_oi_loss_loss_oi, fourdvarnet_lstm_phi_unet_oi_loss_loss_mse, 's--', c='darkslateblue', alpha=0.5,label='Prior: UNet / Solver: LSTM (100 updates) (oi loss)')

    p9 = plt.plot(fourdvarnet_lstm_phi_cov_mse_loss_loss_oi, fourdvarnet_lstm_phi_cov_mse_loss_loss_mse, '-o', c='firebrick', alpha=0.5,label='Prior: Covariance / Solver: LSTM (20 updates) (mse loss)')
    p10 = plt.plot(fourdvarnet_lstm_phi_cov_oi_loss_loss_oi, fourdvarnet_lstm_phi_cov_oi_loss_loss_mse, 's--', c='firebrick', alpha=0.5,label='Prior: Covariance / Solver: LSTM (100 updates) (oi loss)')

    p11 = plt.plot(fourdvarnet_lstm_phi_covl_mse_loss_loss_oi, fourdvarnet_lstm_phi_covl_mse_loss_loss_mse, '-o', c='black', alpha=0.5,label='Prior: Covariance / Solver: LSTM (20 updates) (mse loss)')
    p12 = plt.plot(fourdvarnet_lstm_phi_covl_mse_loss_loss_oi, fourdvarnet_lstm_phi_covl_mse_loss_loss_mse, 's--', c='black', alpha=0.5,label='Prior: Covariance / Solver: LSTM (100 updates) (oi loss)')
    ...
    p5 = plt.plot(np.arange(len(fourdvarnet_fp_phi_unet_mse_loss_loss_oi)), fourdvarnet_fp_phi_unet_mse_loss_loss_oi, '-o', c='darkorange', alpha=0.5,label='Prior: UNet / Solver: FP10 (mse loss)')
    p6 = plt.plot(np.arange(len(fourdvarnet_fp_phi_unet_oi_loss_loss_oi)), fourdvarnet_fp_phi_unet_oi_loss_loss_oi, 's--', c='darkorange', alpha=0.5,label='Prior: UNet / Solver: FP10 (oi loss)')

    p7 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_unet_mse_loss_loss_oi)), fourdvarnet_lstm_phi_unet_mse_loss_loss_oi, '-o', c='darkslateblue', alpha=0.5,label='Prior: UNet / Solver: LSTM (20 updates) (mse loss)')
    p8 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_unet_oi_loss_loss_oi)), fourdvarnet_lstm_phi_unet_oi_loss_loss_oi, 's--', c='darkslateblue', alpha=0.5,label='Prior: UNet / Solver: LSTM (100 updates) (oi loss)')

    p9 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_cov_mse_loss_loss_oi)), fourdvarnet_lstm_phi_cov_mse_loss_loss_oi, '-o', c='firebrick', alpha=0.5,label='Prior: Covariance / Solver: LSTM (20 updates) (mse loss)')
    p10 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_cov_oi_loss_loss_oi)), fourdvarnet_lstm_phi_cov_oi_loss_loss_oi, 's--', c='firebrick', alpha=0.5,label='Prior: Covariance / Solver: LSTM (100 updates) (oi loss)')   

    p11 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_covl_mse_loss_loss_oi)), fourdvarnet_lstm_phi_covl_mse_loss_loss_oi, '-o', c='black', alpha=0.5,label='Prior: Covariance / Solver: LSTM (20 updates) (mse loss)')
    p12 = plt.plot(np.arange(len(fourdvarnet_lstm_phi_covl_mse_loss_loss_oi)), fourdvarnet_lstm_phi_covl_mse_loss_loss_oi, 's--', c='black', alpha=0.5,label='Prior: Covariance / Solver: LSTM (100 updates) (oi loss)')
...
'''
# Grad vs GradLSTM
grad = find_open_ncdf_grads("oi_gp_4dvarnet_mse_loss_test_grad_lstm_"+gp_dataset).loss_oi.isel(patch=1)
lstm_grad = find_open_ncdf_grads("oi_gp_4dvarnet_mse_loss_test_grad_lstm_"+gp_dataset).loss_mse.isel(patch=1)
...
plt.savefig('4DVarNet_xp_GP_'+gp_dataset+'_grads.png')
fig = plt.gcf()
plt.close() 
'''
