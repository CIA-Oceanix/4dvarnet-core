...
class LitModelAugstate(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        if self.model_name == '4dvarnet':
            ...
            return optimizer
        elif self.model_name == '4dvarnet_fp':
    ...
    def on_train_epoch_start(self):
        if self.model_name in ('4dvarnet', '4dvarnet_fp', '4dvarnet_sst'):
            opt = self.optimizers()
    ...
    def compute_loss(self, batch, phase, state_init=(None,)):
        ...
        with torch.set_grad_enabled(True):
            ...
            elif self.model_name in ('4dvarnet_fp'):
                outputs = self.model(state, obs, new_masks)
