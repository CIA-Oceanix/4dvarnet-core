...
python hydra_main_AT.py xp=AT/xp_oi_MODIFs file_paths=hal_AT  entrypoint=test params.save_outputs_path='/work/scratch/trebouta/4dvarnet/logs/${xp_name}/${entrypoint.date_training}'
