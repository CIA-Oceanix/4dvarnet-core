...
class Model_HwithSSTBN_nolin_tanh(torch.nn.Module):
    def __init__(self,shape_data, dT=5,dim=5,width_kernel=3,padding_mode='reflect'):
        ...
        self.convx11 = torch.nn.Conv2d(shape_data, self.dim_obs_channel[1], (3, 3), padding=1, bias=False,padding_mode=padding_mode)
        ...
        self.convx21 = torch.nn.Conv2d(self.dim_obs_channel[1], self.dim_obs_channel[1], (3, 3), padding=1, bias=False,padding_mode=padding_mode)
        ...
        self.convy11 = torch.nn.Conv2d(dT, self.dim_obs_channel[1], (3, 3), padding=1, bias=False,padding_mode=padding_mode)
        ...
        self.convy21 = torch.nn.Conv2d(self.dim_obs_channel[1], self.dim_obs_channel[1], (3, 3), padding=1, bias=False,padding_mode=padding_mode)
