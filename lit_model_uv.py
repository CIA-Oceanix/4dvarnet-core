...
from models import (
    Model_HwithSST_nolin_tanh, ModelLR, Model_H, Model_H_AIS, Model_HwithSST,
...
def get_4dvarnet(hparams):
    ...
    return NN_4DVar.Solver_Grad_4DVarNN(
        ...
        Model_H_AIS(hparams.shape_state[0]),
...
class LitModelUV(pl.LightningModule):
    ...
    def compute_loss(self, batch, phase, state_init=(None,)):
        ...
        obs, new_masks, w_sampling_uv, mask_sampling_uv = self.get_obs_and_mask(
            targets_OI, inputs_Mask, inputs_obs, sst_gt, u_gt_wo_nan, v_gt_wo_nan,ais_dat
        )
