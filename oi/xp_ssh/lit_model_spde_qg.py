from oi.xp_ssh.models_spde_qg import *
from oi.spde import *
from oi.scipy_sparse_tools import *
from math import sqrt
import xarray as xr
#from oi.xp_ssh.metrics import *
...
class LitModel(pl.LightningModule):
    ...
    def test_epoch_end(self, outputs):
        ...
        n_y = int(np.sqrt(nb_nodes))
        n_x = int(np.sqrt(nb_nodes))
        m = np.reshape(m, (n_b,2,n_y,n_x,n_t))
    ...
    def compute_loss(self, batch, phase, state_init=(None,)):
        ...
        with torch.set_grad_enabled(True):
            ...
            if self.loss_type=="ml_loss":
                ...
                print(loss_NLL*(1e-7))
                print(10*loss_All)
                loss = loss_NLL*(1e-7) + 10*loss_All + .1*loss_GAll
