...
import oi.xp_gp.solver_fp as NN_4DVar
...
class LitModel(pl.LightningModule):
    ...
    def compute_loss(self, batch, phase):
        ...
        with torch.set_grad_enabled(True):
            ...
            outputs, cmp_loss = self.model(targets_gt, inputs_init, inputs_missing, inputs_mask, targets_oi)
