...
class Gradient_Solver(nn.Module):
    ...
    def __init__(self ,phi_r, mod_H, m_NormObs, m_NormPhi, shape_data,n_iter_grad, square_root=False):
    ...
    def var_cost(self, gt, x, yobs, mask, oi, estim_params):
        ...
        var_cost_grad = torch.autograd.grad(loss, x, create_graph=False)[0]
