...
import oi.xp_gp.solver_spde_fp as NN_4DVar_spde_fp
...
class LitModel(pl.LightningModule):
    def __init__(self, hparam, *args, **kwargs):
        ...
        self.model = NN_4DVar_spde_fp.Solver_Grad_4DVarNN(
                ...
                None, None, self.shapeData, 0, square_root=self.square_root)
    ...
    def configure_optimizers(self):
        ...
        optimizer = optim.Adam([{'params': self.model.phi_r.parameters(), 'lr': 0.5 * self.hparams.lr_update[0]},
                                ], lr=0.)
        return optimizer
    ...
    def compute_loss(self, batch, phase):
        ...
        with torch.set_grad_enabled(True):
            ...
            outputs, cmp_loss, params = self.model(targets_gt,inputs_init,
                                                                         inputs_missing,
            ...
            if phase=="test2":
                ...
                x_itrp_simu,_ = self.model(inputs_init_simu,
