...
from models import Model_H, Model_HwithSST, Model_HwithSSTBN,Phi_r, ModelLR, Gradient_img, Model_HwithSSTBN_nolin_tanh, Model_HwithSST_nolin_tanh
...
class LitModelAugstate(pl.LightningModule):
    ...
    def build_test_xr_ds_sst(self, outputs, diag_ds):
        ...
        print( self.patch_weight.detach().cpu().shape )
        print( self.patch_weight.detach().cpu() )
