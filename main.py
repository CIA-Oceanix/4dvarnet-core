...
if __name__ == '__main__':
    ...
    for kk in range(0,len(flagProcess)):
        ...
        if flagProcess[kk] == 0:  
            ...
            val_dataloder = torch.utils.data.DataLoader(val_dataset, batch_size=batch_size, shuffle=True, num_workers=4, pin_memory=True)
            ...
            test_dataloder = torch.utils.data.DataLoader(test_dataset, batch_size=batch_size, shuffle=True, num_workers=4, pin_memory=True)
