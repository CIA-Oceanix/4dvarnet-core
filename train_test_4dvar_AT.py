...
class FourDVarNetHydraRunner:
    ...
    def _get_model(self, ckpt_path=None):
        ...
        if ckpt_path:
            ...
            mod = self.lit_cls.load_from_checkpoint(ckpt_path,
                                                    ...
                                                    save_outputs_path=self.cfg.save_outputs_path,
                                                    )
    ...
    def train(self, ckpt_path=None, **trainer_kwargs):
        ...
        log.info('Best checkpoint path :\n{}\n'.format(trainer.checkpoint_callback.best_model_path))
        return mod, trainer
    ...
    def test(self, ckpt_path=None, dataloader="test", _mod=None, _trainer=None, **trainer_kwargs):
        ...
        """
        print()
        #Remove some kwargs arguments
        print('kwargs :', trainer_kwargs)
        try : 
            trainer_kwargs.pop('date_training')
        except : 
            pass
        try : 
            trainer_kwargs.pop('ckpt_file')
        except : 
            pass
        try :
            trainer_kwargs.pop('save_outputs_path')
        except:
            pass
        print('kwargs :', trainer_kwargs)
