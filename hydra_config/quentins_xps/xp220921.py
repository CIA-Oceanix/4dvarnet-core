...
orca_data = {
    'obs_mask_path': '${file_paths.orca_preprocessed}',
    'obs_mask_var': f'five_nadirs',
    'gt_path': '${file_paths.orca_preprocessed}',
    'gt_var': f'ssh',
}

glorys_data = {
    'obs_mask_path': '${file_paths.glorys_preprocessed}',
    'obs_mask_var': f'five_nadirs',
    'gt_path': '${file_paths.glorys_preprocessed}',
    'gt_var': f'ssh',
}
natl_deg_res = lambda dx, dt: {
...
cs.store(name='natl_1_1D', node=natl_deg_res(1, '1D'), group='data', package='params.files_cfg')
cs.store(name='natl_1_14D', node=natl_deg_res(1, '14D'), group='data', package='params.files_cfg')
cs.store(name='natl_05_1D', node=natl_deg_res(1/2, '1D'), group='data', package='params.files_cfg')
cs.store(name='natl_05_7D', node=natl_deg_res(1/2, '7D'), group='data', package='params.files_cfg')
cs.store(name='natl_025_1D', node=natl_deg_res(1/4, '1D'), group='data', package='params.files_cfg')
cs.store(name='glorys12', node=glorys_data, group='data', package='params.files_cfg')
cs.store(name='orca025', node=orca_data, group='data', package='params.files_cfg')

data = {
        'base': '/xp/qfebvre/ds/five_nadirs.yaml',
        'natl1_1D': '/data/natl_1_1D',
        'natl1_14D': '/data/natl_1_14D',
        'natl05_1D': '/data/natl_05_1D',
        'natl05_7D': '/data/natl_05_7D',
        'natl025_1D': '/data/natl_025_1D',
        # 'orca025': '/data/orca025', TODO Handle different split
        'glorys12': '/data/glorys12',
}
